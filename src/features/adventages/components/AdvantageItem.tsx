...
function AdvantageItem({ icon, title, description, ...props }: IAdvantageItem) {
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="flex flex-col bg-secondary-bg h-full rounded-4xl border border-border p-8 pt-6 relative z-99 hover:translate-x-1 hover:-translate-y-1 duration-200">
