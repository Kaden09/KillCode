...
function PortfolioItem({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col overflow-hidden min-[1800px]:flex-row p-2 min-[400px]:p-5 min-[400px]:min-h-160 min-h-180 min-[200px]:min-h-145 min-[1800px]:min-h-full h-full gap-5 min-[1800px]:gap-10 bg-secondary-bg rounded-3xl min-[400px]:rounded-[44px] border border-border min-[1800px]:pr-8 z-99 hover:translate-x-1 hover:-translate-y-1 duration-200">
        <div className="absolute top-0 left-0 w-full h-full group-hover:bg-[#00000025] duration-150" />
        <a
          href="https://t.me/killcode_portfolio"
          target="_blank"
          className="items-center justify-center group gap-3 absolute top-7 right-7 hidden bg-[#00000075] p-2 rounded-full cursor-pointer group-hover:flex hover:bg-[#00000090] duration-150 animate-fade-in-bottom"
        >
          <ArrowUpRight />
          <span>Подробнее</span>
        </a>
